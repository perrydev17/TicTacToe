...
const useTicTacToe = () => {
  ...
  const { playerXAvatar, setPlayerXAvatar, playerOAvatar, setPlayerOAvatar, handleFileUpload } = useAvatars();

  const { showWinnerLine, showVictoryOverlay, triggerGameEnd, resetOverlay } = useGameOverlay();
